        ...
        books.forEach((book) => {
            ...
            bookItem.innerHTML = `
                <div class="book_list__book">
                    <img
                        src="https://kitobxon.com/img_knigi/7177.jpg"
                        alt="${book.title}"
                        class="book_list__book_img"
                    >

                    <div class="book_list__book_info">
                        <h3 class="book_list__book_title">${book.title}</h3>

                        <p class="book_list__book_author">
                            ${book.author}
                        </p>

                        <div class="book_list__pages">
                            <svg
                                class="book_list__pages-icon"
                            ...
                            <p class="book_list__pages_number">
                                ${book.pages} страниц
                            </p>
                        </div>

                        <p class="book_list__book_status ${book.isRead ? 'read' : 'unread'}">
                ...
                <div class="book_list__change">
                    <div class="book_list__change_status">
                        <svg
                            class="book_list__change_status-icon"
                            xmlns="http://www.w3.org/2000/svg"
                            width="24"
                            height="24"
                            viewBox="0 0 24 24"
                        ...
                        <p class="book_list__change_status_text">
                            Изменить статус
                        </p>
                    </div>
                    ...
                    <div class="book_list__delete_book">
                        <svg
                            class="book_list__delete_book-icon"
                            xmlns="http://www.w3.org/2000/svg"
                            width="24"
                            height="24"
                            viewBox="0 0 24 24"
                        ...
                        <p class="book_list__delete_book_text">
                            Удалить книгу
                        </p>
                    </div>
                </div>
